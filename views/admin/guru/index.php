...
<div class="guru-index">
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <div class="person-sub">Kelola data guru</div>
            </div>
            <div class="d-flex gap-2">
                ...
                <?= Html::a('Tambah Guru', ['create'], ['class' => 'btn btn-toska']) ?>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="table-wrap">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px">
                <div style="display:flex;gap:8px;align-items:center;width:100%">
                    <input id="guru-search-input" class="top-search" placeholder="Cari guru (nama, NIP, mapel)..." style="flex:1" />
                    <button id="guru-search-btn" class="btn btn-outline">Cari</button>
                </div>
            </div>
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    [
                        ...
                        'value' => function($m){
                            $name = Html::encode($m->nama_guru);
                            $initials = '';
                            foreach(explode(' ', $m->nama_guru) as $part){ if(trim($part)!='') $initials .= strtoupper($part[0]); }
                            $sub = isset($m->jabatan) ? Html::encode($m->jabatan) : '';
    ...
    (function(){
        ...
        const btn = document.getElementById('guru-search-btn');
        const table = document.querySelector('.guru-index .table-wrap table');
        ...
        function filterRows(){
            ...
            rows.forEach(r=>{
                ...
                const nipCell = r.cells[1];
                const text = ((nameCell&&nameCell.innerText)||'') + ' ' + ((nipCell&&nipCell.innerText)||'');
